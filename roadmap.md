...
- In this step, I added broacasing functionality to elementwise + operation and added elementwise \* operation.
- Learn: Using templates and common types: How to make operators to work for mixed types (int + double -> double)
- Using lambdas
